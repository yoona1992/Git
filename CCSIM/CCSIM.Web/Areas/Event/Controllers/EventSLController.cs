...
namespace CCSIM.Web.Areas.Event.Controllers
{
    public class EventSLController  : CCSIM.Web.Controllers.BaseController
    {
        // GET: Event/EventSL
        ...
        private void LoadData()
        {
            ...
            // 2.获取当前分页数据
            ViewBag.Grid1DataSource = null;//DataSourceUtil.GetPagedDataTable(pageIndex: 0, pageSize: 5, recordCount: recordCount);

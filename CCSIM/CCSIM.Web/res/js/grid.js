...
// 文本 - 证件类型 
function renderCredentialType(value, params) {
...
//Tooltip - 提示信息
function renderTooltip(value, params) {
    params.tdAttrs = {
        'data-qtip': value
    };
    return value;
...
function renderActionField(value, params) {
    return '<a href="javascript:;" class="editfield"><img class="f-grid-cell-icon" src="../res/icon/pencil.png" data-qtip="编辑"></a>';
}

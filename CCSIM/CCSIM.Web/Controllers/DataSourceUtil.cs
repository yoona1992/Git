...
namespace CCSIM.Web
{
    public static class DataSourceUtil
    {
        ...
        public static DataTable GetDataTable2()
        {
            DataTable table = new DataTable();
            table.Columns.Add(new DataColumn("Id", typeof(int)));
            table.Columns.Add(new DataColumn("Name", typeof(String)));  //姓名
            table.Columns.Add(new DataColumn("Gender", typeof(int)));   //性别
            table.Columns.Add(new DataColumn("Age", typeof(int)));  //年龄
            table.Columns.Add(new DataColumn("TelePhone", typeof(String)));   //联系电话
            table.Columns.Add(new DataColumn("CredentialType", typeof(int)));    //证件类型
            table.Columns.Add(new DataColumn("Direction", typeof(String)));    //去向
            table.Columns.Add(new DataColumn("CredentialNum", typeof(String))); //证件号码
            table.Columns.Add(new DataColumn("Address", typeof(String)));   //家庭地址
            table.Columns.Add(new DataColumn("BelongDept", typeof(String)));    //所属部门
            table.Columns.Add(new DataColumn("BelongGrid", typeof(String)));    //所属网格
            ...
            row[5] = 1;
            row[6] = "外地";
            row[7] = "33050319970512230921";
            row[8] = "浙江省湖州市南浔区练市镇莲墩村";
            row[9] = "大队1";
            row[10] = "湖滨花园";
            table.Rows.Add(row);
            ...
            row[5] = 1;
            row[6] = "回本市";
            row[7] = "33050319670817420921";
            row[8] = "浙江省湖州市南浔区练市镇召林村";
            row[9] = "大队1";
            row[10] = "练市医院";
            table.Rows.Add(row);
        ...
        #region GetDataTable3

        /// <summary>
        /// 获取模拟表格3
        /// </summary>
        /// <returns></returns>
        public static DataTable GetDataTable3()
        {
            DataTable table = new DataTable();
            table.Columns.Add(new DataColumn("Id", typeof(int)));
            table.Columns.Add(new DataColumn("PlateNo", typeof(String)));  //车牌号码
            table.Columns.Add(new DataColumn("PlateType", typeof(int)));   //车辆类型
            table.Columns.Add(new DataColumn("CarBrand", typeof(String)));  //车辆品牌
            table.Columns.Add(new DataColumn("BelongDept", typeof(String)));    //所属部门
            table.Columns.Add(new DataColumn("BelongGrid", typeof(String)));    //所属网格
        ...
        #region GetDataTable4

        /// <summary>
        /// 获取模拟表格4
        /// </summary>
        /// <returns></returns>
        public static DataTable GetDataTable4()
        {
            DataTable table = new DataTable();
            table.Columns.Add(new DataColumn("Id", typeof(int)));
            table.Columns.Add(new DataColumn("NetName", typeof(String)));  //网格名称
            table.Columns.Add(new DataColumn("ResidentPopulation", typeof(String)));  //常住人口
            table.Columns.Add(new DataColumn("TransientPopulation", typeof(String)));    //暂住人口
            table.Columns.Add(new DataColumn("AreaPerson", typeof(String)));    //区域人数
            table.Columns.Add(new DataColumn("BelongDept", typeof(String)));   //所属单位
            table.Columns.Add(new DataColumn("BelongRoad", typeof(String)));   //所属街道
        ...
        #region GetDataTable5

        /// <summary>
        /// 获取模拟表格5
        /// </summary>
        /// <returns></returns>
        public static DataTable GetDataTable5()
        {
            DataTable table = new DataTable();
            table.Columns.Add(new DataColumn("Id", typeof(int)));
            table.Columns.Add(new DataColumn("Name", typeof(String)));  //名称
            table.Columns.Add(new DataColumn("BelongDept", typeof(String)));   //所属单位
            table.Columns.Add(new DataColumn("BelongNet", typeof(String)));   //所属网格
            table.Columns.Add(new DataColumn("Type", typeof(String)));   //轨迹类型
        ...
        //位置1
        private static string[] m_Address1 = new string[] {
               "浙江省湖州市南浔区振兴东路74(一方传统菜附近35米)",
               "浙江省湖州市南浔区振兴东路75(练市名家羊肉馆附近42米)",
               "浙江省湖州市南浔区振兴东路87(湖滨花园附近34米)",
               "浙江省湖州市南浔区振兴东路137(练市湖宝羊肉馆附近39米)",
               "浙江省湖州市南浔区振兴东路165(知音酒楼附近35米)",
               "浙江省湖州市南浔区振兴东路165(新概念附近27米)",
               "浙江省湖州市南浔区湖盐公路(锦湖酒楼附近40米)",
               "浙江省湖州市南浔区湖盐公路(奥鑫灯饰附近18米)",
               "浙江省湖州市南浔区迎宾路1(唐盛不锈钢经营部附近37米)",
               "浙江省湖州市南浔区迎宾路68(小辉汽车电瓶电器空调附近42米)",
               "浙江省湖州市南浔区迎宾路69(华盛汉舍卫浴(练市专卖店)附近26米)",
               "浙江省湖州市南浔区迎宾路108(湖州市校油泵东北53米)",
               "浙江省湖州市南浔区广场东路1(杨氏串串烧北80米)",
               "浙江省湖州市南浔区广场东路15号(杨氏串串烧附近17米)",
               "浙江省湖州市南浔区广场东路37-45号(湖滨花园内,那渔那虾附近16米)",
               "浙江省湖州市南浔区广场东路63-67号(湖滨花园内,足留香足道附近3米)",
               "浙江省湖州市南浔区广场东路69(浙江泰隆商业银行(练市社区支行)附近24米)",
               "浙江省湖州市南浔区振兴路26号(天湖酒楼附近18米)",
               "浙江省湖州市南浔区振兴东路75(一方传统菜附近27米)",
               "浙江省湖州市南浔区振兴东路87(湖滨花园附近29米)"
        };
        //位置2
        private static string[] m_Address2 = new string[]
        {
            "浙江省湖州市南浔区万兴路99(光芒太阳能厨卫电器附近14米)",
            "浙江省湖州市南浔区湖盐中路125(光芒太阳能厨卫电器附近26米)",
            "浙江省湖州市南浔区万兴路29号(好年华服装超市练市店-北门附近21米)",
            "浙江省湖州市南浔区湖盐中路119(好又多生活购物中心练市店附近39米)",
            "浙江省湖州市南浔区湖盐中路118(好又多生活购物中心练市店附近30米)",
            "浙江省湖州市南浔区中心路北32号(浙江地税局练市办税服务厅北55米)",
            "浙江省湖州市南浔区中心路北35号(玉林水果超市附近21米)",
            "浙江省湖州市南浔区再兴路146(玉林水果超市附近21米)",
            "浙江省湖州市南浔区再兴路183号(上海苏家爱华附近23米)",
            "浙江省湖州市南浔区再兴路185号(湖州市南浔区交警大队练市中队附近40米)",
            "浙江省湖州市南浔区再兴路188号(练市医院内)",
            "浙江省湖州市南浔区定泉路5(练市医院内)",
            "浙江省湖州市南浔区定泉路6(湖州市练市彩丽线厂附近31米)",
            "浙江省湖州市南浔区定泉路7(湖州紫箩兰针织制衣附近44米)",
            "浙江省湖州市南浔区定泉路3(湖州紫箩兰针织制衣附近24米)",
            "浙江省湖州市南浔区定泉路4(周织附近32米)",
            "浙江省湖州市南浔区湖盐中路131-1(南浔练市海岩兽药经营部附近13米)",
            "浙江省湖州市南浔区万兴路99(练市湖盐家电城附近16米)",
            "浙江省湖州市南浔区湖盐中路131-1(光芒太阳能厨卫电器附近26米)"
        };
        //位置3
        private static string[] m_Address3 = new string[]
        {
            "浙江省湖州市南浔区(练市人民法庭东南116米)",
            "浙江省湖州市南浔区(练市车友会汽车销售服务有限公司附近17米)",
            "浙江省湖州市南浔区(金美丹商务宾馆附近27米)",
            "浙江省湖州市南浔区(莱茵电梯(中国)有限公司西南67米)",
            "浙江省湖州市南浔区(莱茵电梯(中国)有限公司东南106米)",
            "浙江省湖州市南浔区(黑金刚(福建)自动化科技股份分公司附近18米)",
            "浙江省湖州市南浔区(钱峰烟酒副食西52米)",
            "浙江省湖州市南浔区(世纪阳光北62米)",
            "浙江省湖州市南浔区湖盐公路(东清风桥西南195米)",
            "浙江省湖州市南浔区湖盐公路(东清风桥西70米)",
            "浙江省湖州市南浔区盐湖东路(浙江泰祥光伏科技西75米)",
            "浙江省湖州市南浔区盐湖东路(浙江泰祥光伏科技西191米)",
            "浙江省湖州市南浔区盐湖东路(佳佳汽车服务中心东145米)",
            "浙江省湖州市南浔区盐湖东路(湖州鸿尔纺织有限公司西南69米)",
            "浙江省湖州市南浔区湖盐东路95号(练市镇附近31米)",
            "浙江省湖州市南浔区湖盐东路16(兄弟浴场附近16米)",
            "浙江省湖州市南浔区南大街(怡都商务宾馆附近8米)",
            "浙江省湖州市南浔区南大街(阿新饭店东南51米)",
            "浙江省湖州市南浔区(新华上海贵金属交易中心(练市营业部)东南95米)",
            "浙江省湖州市南浔区(农厨鱼味馆附近23米)",
            "浙江省湖州市南浔区(花圣堂西南227米)",
            "浙江省湖州市南浔区(湖州市地方税务局南浔税务分局东南121米)",
            "浙江省湖州市南浔区(练市车友会汽车销售服务有限公司附近37米)"
        };
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetDataTable6(int id)
        {
            DataTable table = new DataTable();
            table.Columns.Add(new DataColumn("Id", typeof(int)));
            table.Columns.Add(new DataColumn("Lon", typeof(String)));  //经度
            table.Columns.Add(new DataColumn("Lat", typeof(String)));   //纬度
            table.Columns.Add(new DataColumn("PassAddress", typeof(String)));   //经过地点
            table.Columns.Add(new DataColumn("PassTime", typeof(String)));   //经过时间
            ...
            {
                case 101:   //张三
                    foreach (var lonAndLat in m_lonAndLat1)
                    {
                        row = table.NewRow();
                        row[0] = index;
                        row[1] = lonAndLat.Split(',')[1];
                        row[2] = lonAndLat.Split(',')[0];
                        row[3] = m_Address1[index];
                        //var coder = BaiduGeocoderBLL.GeoCoder(lonAndLat.Split(',')[0], lonAndLat.Split(',')[1]);
                        //if (string.IsNullOrWhiteSpace(coder.Result.Sematic_description))
                        //{
                        //    row[3] = coder.Result.Formatted_Address;
                        //}
                        //else
                        //{
                        //    row[3] = coder.Result.Formatted_Address + "(" + coder.Result.Sematic_description + ")";
                        //}
                        row[4] = DateTime.Now.AddDays(-1).AddMinutes(-index).ToString("yyyy-MM-dd HH:mm:ss");
                        table.Rows.Add(row);
                    ...
                    break;
                case 102:   //李四
                    foreach (var lonAndLat in m_lonAndLat2)
                    {
                        row = table.NewRow();
                        row[0] = index;
                        row[1] = lonAndLat.Split(',')[1];
                        row[2] = lonAndLat.Split(',')[0];
                        row[3] = m_Address2[index];
                        //var coder = BaiduGeocoderBLL.GeoCoder(lonAndLat.Split(',')[0], lonAndLat.Split(',')[1]);
                        //if (string.IsNullOrWhiteSpace(coder.Result.Sematic_description))
                        //{
                        //    row[3] = coder.Result.Formatted_Address;
                    ...
                    break;
                case 103:   //浙E00000
                    foreach (var lonAndLat in m_lonAndLat3)
                    {
                        row = table.NewRow();
                        row[0] = index;
                        row[1] = lonAndLat.Split(',')[1];
                        row[2] = lonAndLat.Split(',')[0];
                        row[3] = m_Address3[index];
                        //var coder = BaiduGeocoderBLL.GeoCoder(lonAndLat.Split(',')[0], lonAndLat.Split(',')[1]);
                        //if (string.IsNullOrWhiteSpace(coder.Result.Sematic_description))
                        //{
                        //    row[3] = coder.Result.Formatted_Address;
        ...
        #region GetDataTable7

        /// <summary>
        /// 获取模拟表格7
        /// </summary>
        /// <returns></returns>
        public static DataTable GetDataTable7()
        {
            DataTable table = new DataTable();
            table.Columns.Add(new DataColumn("Id", typeof(int)));
            table.Columns.Add(new DataColumn("Name", typeof(String)));  //名称
            table.Columns.Add(new DataColumn("Location", typeof(String)));   //地点
            table.Columns.Add(new DataColumn("AlarmTime", typeof(String)));   //报警时间
            table.Columns.Add(new DataColumn("Type", typeof(String)));   //报警类型
            ...
            row[0] = 101;
            row[1] = "张三";
            row[2] = "浙江省湖州市南浔区能源路58";
            row[3] = "2018-06-05 13:30:56";
            row[4] = "人员报警";
            table.Rows.Add(row);
            ...
            row[0] = 102;
            row[1] = "李四";
            row[2] = "浙江省湖州市南浔区湖盐中路119";
            row[3] = "2018-06-05 17:20:35";
            row[4] = "人员报警";
            table.Rows.Add(row);
        ...
        #region GetTotalCount3 GetPagedDataTable3
        ...
        {
            return GetTotalCount3(String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static int GetTotalCount3(string searchKeyword)
        {
            DataTable source = DataSourceUtil.GetDataTable3();
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable3(int pageIndex, int pageSize, int recordCount)
        {
            return GetPagedDataTable3(pageIndex, pageSize, recordCount, String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable3(int pageIndex, int pageSize, int recordCount, string searchKeyword)
        {
            //// 对传入的 pageIndex 进行有效性验证//////////////
            int pageCount = recordCount / pageSize;
            if (recordCount % pageSize != 0)
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable3(int pageIndex, int pageSize, int recordCount, string sortField, string sortDirection)
        {
            return GetPagedDataTable3(pageIndex, pageSize, recordCount, sortField, sortDirection, String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable3(int pageIndex, int pageSize, int recordCount, string sortField, string sortDirection, string searchKeyword)
        {
            //// 对传入的 pageIndex 进行有效性验证//////////////
            int pageCount = recordCount / pageSize;
            if (recordCount % pageSize != 0)
        ...
        #region GetTotalCount4 GetPagedDataTable4
        ...
        {
            return GetTotalCount4(String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static int GetTotalCount4(string searchKeyword)
        {
            DataTable source = DataSourceUtil.GetDataTable3();
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable4(int pageIndex, int pageSize, int recordCount)
        {
            return GetPagedDataTable4(pageIndex, pageSize, recordCount, String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable4(int pageIndex, int pageSize, int recordCount, string searchKeyword)
        {
            //// 对传入的 pageIndex 进行有效性验证//////////////
            int pageCount = recordCount / pageSize;
            if (recordCount % pageSize != 0)
            ...
            DataTable source = DataSourceUtil.GetDataTable4();
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable4(int pageIndex, int pageSize, int recordCount, string sortField, string sortDirection)
        {
            return GetPagedDataTable4(pageIndex, pageSize, recordCount, sortField, sortDirection, String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable4(int pageIndex, int pageSize, int recordCount, string sortField, string sortDirection, string searchKeyword)
        {
            //// 对传入的 pageIndex 进行有效性验证//////////////
            int pageCount = recordCount / pageSize;
            if (recordCount % pageSize != 0)
        ...
        #region GetTotalCount5 GetPagedDataTable5
        ...
        {
            return GetTotalCount5(String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static int GetTotalCount5(string searchKeyword)
        {
            DataTable source = DataSourceUtil.GetDataTable5();
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable5(int pageIndex, int pageSize, int recordCount)
        {
            return GetPagedDataTable5(pageIndex, pageSize, recordCount, String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable5(int pageIndex, int pageSize, int recordCount, string searchKeyword)
        {
            //// 对传入的 pageIndex 进行有效性验证//////////////
            int pageCount = recordCount / pageSize;
            if (recordCount % pageSize != 0)
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable5(int pageIndex, int pageSize, int recordCount, string sortField, string sortDirection)
        {
            return GetPagedDataTable5(pageIndex, pageSize, recordCount, sortField, sortDirection, String.Empty);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable5(int pageIndex, int pageSize, int recordCount, string sortField, string sortDirection, string searchKeyword)
        {
            //// 对传入的 pageIndex 进行有效性验证//////////////
            int pageCount = recordCount / pageSize;
            if (recordCount % pageSize != 0)
        ...
        #region GetTotalCount6 GetPagedDataTable6

        /// <summary>
        /// 模拟返回总项数
        /// </summary>
        /// <returns></returns>
        public static int GetTotalCount6(int id)
        {
            DataTable source = DataSourceUtil.GetDataTable6(id);
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable6(int pageIndex, int pageSize, int recordCount, int id)
        {
            //// 对传入的 pageIndex 进行有效性验证//////////////
            int pageCount = recordCount / pageSize;
            if (recordCount % pageSize != 0)
        ...
        #region GetTotalCount7 GetPagedDataTable7

        /// <summary>
        /// 模拟返回总项数
        /// </summary>
        /// <returns></returns>
        public static int GetTotalCount7()
        {
            DataTable source = DataSourceUtil.GetDataTable7();
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetPagedDataTable7(int pageIndex, int pageSize, int recordCount)
        {
            //// 对传入的 pageIndex 进行有效性验证//////////////
            int pageCount = recordCount / pageSize;
            if (recordCount % pageSize != 0)
